...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!project) {
    return {
      title: "Project Not Found | Dreambuild Design Studio",
    };
  }

  return {
    title: `${project.title} | Dreambuild Design Studio`,
      ...
      <section className="pb-20 lg:pb-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="overflow-hidden rounded-2xl">
              <div className="aspect-[4/5] bg-gradient-to-br from-[#d8cec0] via-[#e8e0d4] to-[#ccc0b0]" />
            </div>
            <div className="overflow-hidden rounded-2xl">
              <div className="aspect-[4/5] bg-gradient-to-br from-[#f0ebe3] via-[#e4dcd0] to-[#d0c4b4]" />
            </div>
            <div className="overflow-hidden rounded-2xl sm:col-span-2">
              <div className="aspect-[21/9] bg-gradient-to-br from-[#e0d8cc] via-[#d0c4b4] to-[#c4b8a8]" />
            </div>
            <div className="overflow-hidden rounded-2xl">
              <div className="aspect-square bg-gradient-to-br from-[#e8e0d4] via-[#d4c8b8] to-[#c0b0a0]" />
            </div>
            <div className="overflow-hidden rounded-2xl">
              <div className="aspect-square bg-gradient-to-br from-[#d8cec0] via-[#e8e0d4] to-[#ccc0b0]" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-2">
            <Link
              ...
              className="group rounded-2xl border border-[var(--border)] p-6 transition-all hover:border-[var(--foreground)] lg:p-8"
            >
            ...
            <Link
              ...
              className="group rounded-2xl border border-[var(--border)] p-6 text-right transition-all hover:border-[var(--foreground)] lg:p-8"
            >
              <span className="text-xs font-medium tracking-widest text-[var(--muted)] uppercase">
                Next Project
              </span>
